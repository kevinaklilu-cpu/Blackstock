...
APPROVED_SOURCE_PROVIDER_ID="${BLACKSTOCK_APPROVED_SOURCE_PROVIDER_ID:-}"
APPROVED_SOURCE_PROVIDER_ENDPOINT="${BLACKSTOCK_APPROVED_SOURCE_PROVIDER_ENDPOINT:-}"
APPROVED_SOURCE_PROVIDER_YOUTUBE_APPROVAL_REFERENCE="${BLACKSTOCK_APPROVED_SOURCE_PROVIDER_YOUTUBE_APPROVAL_REFERENCE:-}"
APPROVED_SOURCE_PROVIDER_VERIFIED_AT="${BLACKSTOCK_APPROVED_SOURCE_PROVIDER_VERIFIED_AT:-}"
...
<key>BlackstockApprovedSourceProviderID</key><string>${APPROVED_SOURCE_PROVIDER_ID}</string>
<key>BlackstockApprovedSourceProviderEndpoint</key><string>${APPROVED_SOURCE_PROVIDER_ENDPOINT}</string>
<key>BlackstockApprovedSourceProviderYouTubeApprovalReference</key><string>${APPROVED_SOURCE_PROVIDER_YOUTUBE_APPROVAL_REFERENCE}</string>
<key>BlackstockApprovedSourceProviderVerifiedAt</key><string>${APPROVED_SOURCE_PROVIDER_VERIFIED_AT}</string>
</dict></plist>
PLIST
