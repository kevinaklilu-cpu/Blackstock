...
requirements = {
    ...
    ".github/workflows/ci.yml": [
        ...
        "lipo /Applications/Blackstock.app/Contents/MacOS/Blackstock -verify_arch arm64 x86_64",
        "lipo /Applications/Blackstock.app/Contents/Helpers/BlackstockE2ESmoke -verify_arch arm64 x86_64",
        "BLACKSTOCK_E2E_PASS",
        'data["workspaceRightsDeclarationAccepted"] is True',
        'data["opportunitySourceBound"] is True',
        'data["localClipCandidateGenerated"] is True',
        'data["supplementalVideoRendered"] is True',
        'data["supplementalAudioMixed"] is True',
        'data["reframeRendered"] is True',
        'data["captionBurnInRendered"] is True',
        'data["textOverlayRendered"] is True',
