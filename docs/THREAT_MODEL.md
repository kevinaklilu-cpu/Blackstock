...
- Nach der Installation erzeugen Apple-Silicon- und Intel-Runner jeweils einen maschinenlesbaren Release-Fingerprint aus Bundle-ID, Version, Build, Source-Commit, SHA-256 des tatsächlich installierten Universal-2-Executables und macOS-Installer-Receipt. Bis auf die bewusst unterschiedliche Runner-Architektur müssen diese Identitätsfelder exakt übereinstimmen; damit wird belegt, dass auf beiden Architekturen derselbe installierte Release ausgeführt wurde.
