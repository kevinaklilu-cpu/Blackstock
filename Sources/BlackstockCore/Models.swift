...
public enum RenderCanvas: String, CaseIterable, Codable, Sendable, Identifiable {
    ...
    public var id: String { rawValue }
    public var label: String { switch self { case .source: return "Quelle"; case .landscape16x9: return "16:9"; case .vertical9x16: return "9:16"; case .square1x1: return "1:1"; case .portrait4x5: return "4:5" } }
    public var pixelWidth: Int? { switch self { case .source: return nil; case .landscape16x9: return 1920; case .vertical9x16, .square1x1, .portrait4x5: return 1080 } }
    public var pixelHeight: Int? { switch self { case .source: return nil; case .landscape16x9: return 1080; case .vertical9x16: return 1920; case .square1x1: return 1080; case .portrait4x5: return 1350 } }
}
...
public struct ContentIdea: Codable, Identifiable, Sendable, Equatable {
    public let id: String; public let topic: String; public let workingTitle: String; public let recommendedFormat: VideoFormat; public let evidence: [String]; public let sourceVideoIDs: [String]
...
public struct Project: Codable, Identifiable, Sendable, Equatable {
    ...
    public var targetChannelTitle: String?
    ...
    public var publishedVideoID: String?
    public var createdAt: Date
    public var updatedAt: Date

    public init(
        id: UUID = UUID(), title: String, targetChannelID: String? = nil, targetChannelTitle: String? = nil,
        sourceVideoID: String? = nil, sourceEvidenceIDs: [String] = [], localMediaURL: URL? = nil,
        targetFormat: VideoFormat = .short, transcript: String = "", notes: String = "", workingHook: String = "",
        titleVariants: [String] = [], editInSeconds: Double? = nil, editOutSeconds: Double? = nil,
        renderedOutputURL: URL? = nil, thumbnailURL: URL? = nil, publishTitle: String? = nil,
        publishDescription: String? = nil, publishTags: [String]? = nil, renderCanvas: RenderCanvas? = nil,
        cropAnchorX: Double? = nil, cropAnchorY: Double? = nil, lastExportPackageURL: URL? = nil,
        publishedVideoID: String? = nil, createdAt: Date = Date(), updatedAt: Date = Date()
    ) {
        self.id = id; self.title = title; self.targetChannelID = targetChannelID; self.targetChannelTitle = targetChannelTitle
        self.sourceVideoID = sourceVideoID; self.sourceEvidenceIDs = sourceEvidenceIDs; self.localMediaURL = localMediaURL
        self.targetFormat = targetFormat; self.transcript = transcript; self.notes = notes; self.workingHook = workingHook
        self.titleVariants = titleVariants; self.editInSeconds = editInSeconds; self.editOutSeconds = editOutSeconds
        self.renderedOutputURL = renderedOutputURL; self.thumbnailURL = thumbnailURL; self.publishTitle = publishTitle
        self.publishDescription = publishDescription; self.publishTags = publishTags; self.renderCanvas = renderCanvas
        self.cropAnchorX = cropAnchorX; self.cropAnchorY = cropAnchorY; self.lastExportPackageURL = lastExportPackageURL
        self.publishedVideoID = publishedVideoID; self.createdAt = createdAt; self.updatedAt = updatedAt
    }
