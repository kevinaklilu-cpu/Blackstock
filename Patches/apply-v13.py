...
RELEASE_NOTES_TEXT = r"""# Blackstock 13.0.0 · Build 1300

Blackstock bleibt Blackstock. Die Versionsnummer ist kein sichtbarer Produktname.

## Geführter Arbeitsablauf
- Neue Startseite mit permanentem „Dein nächster Schritt“-Guide.
- Blackstock erkennt automatisch, ob Verbindung, Berechtigungen, Kanalstrategie, Trends, Produktion oder Analyse als Nächstes dran sind.
- Eine klare Hauptaktion pro Zustand statt konkurrierender Buttons.
- Fortschrittsanzeige für Kanal, Upload, Strategie, Trends und erstes Video.
- Kanalstrategie mit Fokusführung direkt zum fehlenden Feld.
- Nach erfolgreicher Google-/YouTube-Verbindung wird der Nutzer direkt zur Kanalstrategie weitergeführt.
- Topbar „Nächster Schritt“ führt jederzeit zurück zur geführten Übersicht.

## Klarere Sprache
- Sichtbares Versionsbranding aus Sidebar, Produktionsmeldungen und Hauptworkflow entfernt.
- Klarere deutsche Schritte: Kanal verbinden → Thema festlegen → Trends finden → Video analysieren → Format wählen → Schneiden → Qualität prüfen → Rendern → Hochladen → Verbessern.
- Qualitäts- und Produktionsmeldungen erklären konkret, warum Blackstock blockiert und was danach zu tun ist.

## Release
- Version 13.0.0, Build 1300.
...
(root / "RELEASE_NOTES_v13.md").write_text(RELEASE_NOTES_TEXT)
